...
class ResponseCode extends $pb.ProtobufEnum {
  ...
  static const ResponseCode PARAM_ERROR = ResponseCode._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PARAM_ERROR');
  static const ResponseCode ACCESS_DENIED = ResponseCode._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACCESS_DENIED');
